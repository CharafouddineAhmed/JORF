...
def task_article(FILE_NAME):
    ...
    from bs4 import BeautifulSoup #import du packet pour l'identification
    ...
    logging.info(f'[OK] Nom du fichier xml : {FILE_NAME} ')
    ...
    try:
        ...
        with open(f'C:\\Users\\CS5764\\Desktop\\codeNapoleon\\Resultats\\articles\\{id}.json', mode="w+", encoding="utf-8") as jsonFile:
